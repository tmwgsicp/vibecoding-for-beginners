...
从传统财务出发，经历财务数字化转型，到 AI 自动化开发，一路跨界。靠 AI 重度协作 + 14 步 Vibe Coding 方法论，独立构建了多个 SaaS 产品并稳定运营。目前为外企提供全栈 AI 自动化开发服务，同时经营个人产品矩阵。

教程里的 14 步流程、7 大陷阱，全部是做项目时踩坑后总结出来的，不是先有理论再凑案例。
...
2. **被一家企业看到**，让我做全职 AI 自动化专家 — 职业转型就这么发生了，财务出身直接转技术岗。不是因为考了证、读了 CS，是因为 AI 把执行力放大到能交付真实成果的程度
3. **2026 年初**：跟很多想用 AI 做产品的人聊过，发现他们卡的不是"AI 怎么用"，而是"做什么、怎么验证、怎么不死在半路"
4. **2026 年 3-4 月**：把自己做项目时反复用到的判断框架沉淀成 14 步 + 7 大陷阱
5. **2026 年 5 月**：开源教程 + 配套 Vibe Tutor 工具

**这本教程不是"先看再做"的教科书，是"先做出过、然后告诉你哪些坑别踩"的实战回放。**
...
- 多个项目的开发，积累了一些"工程直觉" —— 能大致判断代码逻辑走向对不对，但让我从头写完整业务逻辑还是会卡
